...
- **Debuging myself**: I have thoroughly reviewed and tested these features myself. If you notice any bugs, please open an [issue](https://github.com/OzieXtreme/adblock-dns-webinterface/issues) thread so I can fix them.
